...
MiniHues.apply_palette = function(palette, plugins, opts)
  ...
  hi('@markup.heading.4', { fg=heading_colors[4],bg=nil, bold = true })
  hi('@markup.heading.5', { fg=heading_colors[5],bg=nil, bold = true })
  hi('@markup.heading.6', { fg=heading_colors[6],bg=nil, bold = true })
  ...
  if has_integration('folke/snacks.nvim') then
    ...
    hi("SnacksPickerMatch", { fg = p.accent, bg = opts.dim_popup and p.bg or p.bg_edge, bold = true, undercurl=true })
