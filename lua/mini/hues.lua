...
MiniHues.apply_palette = function(palette, plugins, opts)
  ...
  hi('@lsp.type.regexp',             { link='@string.special' })
  ...
  hi('@lsp.mod.abstract',        { fg=nil, bg=nil, italic=true })
  hi('@lsp.mod.async',           { fg=nil, bg=nil, italic=true })
  hi('@lsp.mod.declaration',     { fg=nil, bg=nil, bold=true })
  hi('@lsp.mod.defaultLibrary',  { link='@variable.builtin' })
  hi('@lsp.mod.deprecated',      { fg=p.red, bg=nil, strikethrough=true })
  hi('@lsp.mod.definition',      { fg=nil, bg=nil, bold=true })
  hi('@lsp.mod.documentation',   { link='@comment' })
  hi('@lsp.mod.readonly',        { link='@constant' })
  hi('@lsp.mod.static',          { fg=nil, bg=nil, bold=true })
