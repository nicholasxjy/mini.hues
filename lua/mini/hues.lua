...
MiniHues.apply_palette = function(palette, plugins, opts)
  ...
  hi('@markup.heading.1', { fg=heading_colors[1], bold = true })
  hi('@markup.heading.2', { fg=heading_colors[2], bold = true })
  hi('@markup.heading.3', { fg=heading_colors[3], bold = true })
  hi('@markup.heading.4', { fg=heading_colors[4], bold = true })
  hi('@markup.heading.5', { fg=heading_colors[5], bold = true })
  hi('@markup.heading.6', { fg=heading_colors[6], bold = true })
