...
MiniHues.apply_palette = function(palette, plugins, opts)
  ...
  hi('Operator',       { fg=p.fg_mid,      bg=nil })
  ...
  hi('@markup.heading.1', { bg = heading_colors[1], fg = p.orange })
  hi('@markup.heading.2', { bg=heading_colors[2], fg=p.yellow })
  hi('@markup.heading.3', { bg=heading_colors[3], fg=p.lime })
  hi('@markup.heading.4', { bg=heading_colors[4], fg=p.green })
  hi('@markup.heading.5', { bg=heading_colors[5], fg=p.teal })
  hi('@markup.heading.6', { bg=heading_colors[6], fg=p.blue })
  ...
  if has_integration('nvim-mini/mini.nvim') or has_integration('echasnovski/mini.nvim') then
    ...
    hi('MiniPickIconDirectory', { link='SnacksPickerDir' })
  ...
  if has_integration('folke/snacks.nvim') then
    ...
    hi("SnacksPickerMatch", { fg = p.accent, bg = p.bg_edge, bold = true })
